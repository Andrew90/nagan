...
SMS* sms;
//---------------------------------------------------------------------------
// здесь принудительно прописать название сервака - например, ALEXANDER_KODER и т.д.
...
//---------------------------------------------------------------------------
// послыает любую строку в сервер
...
bool SMS::SendZoneThickness(int zone , double thickness)
{
	...
	str += IntToStr(zone);
	str += " th ";
	if(thickness > Globals::rtube.getMathSettings().nominThickness)
