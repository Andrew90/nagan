...
public:
	...
	bool BlinkOutBit(byte bit);		// кратковременно выставляет и сбрасывает выходной бит, возвращает true в случае успеха
...
public:
	...
	bool BlinkOutSignal(String SignalName);		// выставляет, а затем после задержки сбрасывает сигнал , returns true is succeed
